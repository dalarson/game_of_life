...
export class Universe {
     ...
     * @param {number} width
     * @param {number} height
     * @param {Uint8Array} initial_cells
     * @returns {Universe}
     */
    static new_with_cells(width, height, initial_cells) {
        const ptr0 = passArray8ToWasm0(initial_cells, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.universe_new_with_cells(width, height, ptr0, len0);
        return Universe.__wrap(ret);
    }
    tick() {
